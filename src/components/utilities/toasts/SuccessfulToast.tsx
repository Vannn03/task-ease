...
const SuccessfulToast = ({ toast, description }: SuccessfulToastProps) => {
    return (
        <div
            className={`${toast ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'} fixed bottom-6 left-1/2 z-50 w-72 -translate-x-1/2 rounded bg-base-100 shadow-lg transition-all`}
        >
